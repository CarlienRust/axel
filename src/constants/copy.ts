...
export const COPY = {
  ...
  toolsLandingDesc: 'Breath, body, ground, name it',
  toolsPrepDesc: 'Build your picture over time',
  landingToolsTitle: 'Landing tools',
  landingToolsSubtitle: 'Short exercises when you need to land.',
  landingBreath: 'Take a breath',
  landingBreathDesc: '1–2 minutes',
  landingResetBody: 'Reset your body',
  landingResetBodyDesc: '2–5 minutes',
  landingGround: 'Ground',
  landingGroundDesc: '2–3 minutes',
  landingNameIt: "Name what's happening",
  landingNameItDesc: '1–2 minutes',
  resetBodyStep1: 'Unclench your jaw and drop your shoulders.',
  resetBodyStep2: 'Shake out your hands and arms for a few seconds.',
  resetBodyStep3: 'Press your feet into the floor. Notice the contact.',
  resetBodyStep4: 'Roll your neck slowly once each way.',
  nameItPrompt: 'What is happening right now, in one sentence?',
  ...
  prepMyStory: 'My story',
  prepMyStoryDesc: 'Strengths, challenges, and experiences',
  prepPatterns: 'Patterns',
  prepPatternsDesc: "What you're noticing over time",
  prepTimeline: 'Timeline',
  prepTimelineDesc: 'See your journey visually',
  prepTimelineNote: 'Anything you want to add about how things unfolded over time?',
  prepTimelineEmpty: 'Complete a few brain dumps first. Your timeline will appear here.',
